use super::Ascent;
use crate::state_machine::{Landed, RocketStates, State, StateMachineContext, TransitionInto, StateMachineSharedResources};
...
impl State for Apogee {
    ...
    fn step(&mut self, context: &mut StateMachineContext) -> Option<RocketStates> {
        ...
        context.shared_resources.sbg_data.lock(|data| {
            if data.height < 450.0 {

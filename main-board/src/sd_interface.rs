...
pub struct SdInterface {
    pub sd_controller: sd::Controller<
        sd::SdMmcSpi<
            hal::sercom::spi::Spi<
                hal::sercom::spi::Config<
                    hal::sercom::spi::Pads<
                        hal::sercom::Sercom1,
                        hal::sercom::IoSet1,
                        hal::gpio::Pin<hal::gpio::PA19, hal::gpio::Alternate<hal::gpio::C>>,
                        hal::gpio::Pin<hal::gpio::PA16, hal::gpio::Alternate<hal::gpio::C>>,
                        hal::gpio::Pin<hal::gpio::PA17, hal::gpio::Alternate<hal::gpio::C>>,
                    >,
                >,
                hal::sercom::spi::Duplex,
            >,
            hal::gpio::Pin<hal::gpio::PA18, hal::gpio::Output<hal::gpio::PushPull>>,
        >,
        TimeSink,
    >,
...
impl SdInterface {
    pub fn new(
        ...
        cs: hal::gpio::Pin<hal::gpio::PA18, hal::gpio::Output<hal::gpio::PushPull>>,
        sck: hal::gpio::Pin<hal::gpio::PA17, hal::gpio::Output<hal::gpio::PushPull>>,
        miso: hal::gpio::Pin<hal::gpio::PA19, hal::gpio::Output<hal::gpio::PushPull>>,
        mosi: hal::gpio::Pin<hal::gpio::PA16, hal::gpio::Output<hal::gpio::PushPull>>,
    ) -> Self {
        let pads_spi =
            hal::sercom::spi::Pads::<hal::sercom::Sercom1, hal::sercom::IoSet1>::default()
                .sclk(sck)
                .data_in(miso)
                .data_out(mosi);
        let sdmmc_spi = hal::sercom::spi::Config::new(mclk, sercom, pads_spi, spi_clk.freq())
            .length::<hal::sercom::spi::lengths::U1>()
            .bit_order(hal::sercom::spi::BitOrder::MsbFirst)
            .spi_mode(hal::sercom::spi::MODE_0)
            .enable();
        sdmmc_spi.write(b"Hello, world!");
